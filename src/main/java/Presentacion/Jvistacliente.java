    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        if (evt.getClickCount() == 2) {
           ...
           /* apellidos = tablalistado.getValueAt(fila, 2).toString();
            ...
            direccion = tablalistado.getValueAt(fila, 5).toString();
            telefono = tablalistado.getValueAt(fila, 6).toString();
            email = tablalistado.getValueAt(fila, 7).toString();

            tablalistado.getValueAt(fila, 2).toString();
            Jmanejoreservas.txtidcliente.setText(cod);
            Jmanejoreservas.txtnombres.setText(nombres);
            Jmanejoreservas.txtapellidos.setText(apellidos);
            Jmanejoreservas.txtnumerodocumento.setText(String.valueOf(numerodocumento));
            Jmanejoreservas.comtipodocumento.setSelectedItem(tipodocumento);
            Jmanejoreservas.txttelefono.setText(telefono);
            Jmanejoreservas.txtemail.setText(email);*/
